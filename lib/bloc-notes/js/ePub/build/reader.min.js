EPUBJS.reader = {}, EPUBJS.reader.plugins = {}, function (a) {
    ...
    })), this.setBookKey(this.settings.bookPath), this.settings.restore && this.isSaved() && this.applySavedSettings(), this.settings.styles = this.settings.styles || {fontSize: "100%"}, this.book = c = new EPUBJS.Book({
    ...
    var b = this.isBookmarked(a);
    -1 !== b && (delete this.settings.bookmarks[b], this.trigger("reader:unbookmarked", b))
