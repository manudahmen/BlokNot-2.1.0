    ...
    <tr>
        ...
        <td valign="top">
            ...
            <table border="0" cellspacing="2" cellpadding="0">
                    ...
                    <td colspan="3">
                        <table width="100%">
                            <tr>
                                ...
                                <td align="center" valign="bottom"><input type="button" value="Save" onclick="save()">
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td valign="top">
                        <canvas id="toolpanel" width="65" height="362"></canvas>
                        <br/>
                        <canvas id="actionpanel2" width="65" height="32"></canvas>
                    </td>
                    <td valign="top">
                        <canvas id="drawcanvas" width="600" height="400" style="border: 1px solid black;">Your browser
                            doesn't support canvas tag. Please use IE9 or Firefox or Chrome or Safary
                        </canvas>
                    </td>
                    <td valign="top">
                        <table>
                            ...
                            <tr>
                                <td><img src="./lib/painter/cliparts/apple.gif" draggable="true"></td>
                            </tr>
                            <tr>
                                <td><img src="./lib/painter/cliparts/cherry.gif" draggable="true"></td>
                            </tr>
                            <tr>
                                <td><img src="./lib/painter/cliparts/ladybird.gif" draggable="true"></td>
                            </tr>
                            <tr>
                                <td><img src="./lib/painter/cliparts/flower.gif" draggable="true"></td>
                            </tr>
                            <tr>
                                <td><img src="./lib/painter/cliparts/raisin.gif" draggable="true"></td>
                            </tr>
                            <tr>
                                <td><img src="./lib/painter/cliparts/carrot.gif" draggable="true"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <!-- Save Form -->
            <form id="save_form" action="save.php" method="POST"><input id="image_data" name="image_data" type="hidden"
                                                                        value=""></form>
