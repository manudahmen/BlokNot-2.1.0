...
<ul>
    ...
    <li class="button_appdoc"><a href="?composant=del.txt&document=<?php echo rawurlencode($document) ?>">Supprimer une
            note</a></li>
    <li class="button_appdoc"><a href="?composant=edit.txt&document=<?php echo rawurlencode($document) ?>">Modifier,
            renommer, supprimer une note</a></li>
