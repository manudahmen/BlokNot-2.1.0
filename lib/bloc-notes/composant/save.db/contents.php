...
if ($_GET["option"] == "aucunemethodechosie.doc") {
    ...
    if (($folder_id_what == $folder_id_where) && ($folder_id_what != NULL)
        ...
        if (simpleQ($sql, $mysqli)) {
            ...
            <ul>
                <li class='button_appdoc'><a class='button_appdoc'
                                             href='?composant=browser&dbdoc=<?php echo $folder_id_what; ?>'>Retour au
                        répertoire d'origine</a>
                </li>
                <li class='button_appdoc'><a class='button_appdoc'
                                             href='?composant=browser&dbdoc=<?php echo $where; ?>'>Vers la
                        destination</a>
                </li>
            </ul>
    ...
    if (($folder_id_where != NULL)) {
        ...
        if (simpleQ($sql, $mysqli)) {
            ...
            <h1>Note déplacée avec succès</h1>
            <ul>
                <li class='button_appdoc'><a class='button_appdoc' href='?composant=browser&dbdoc=<?php echo $what; ?>'>Retour
                        au répertoire d'origine</a>
                </li>
                <li class='button_appdoc'><a class='button_appdoc'
                                             href='?composant=browser&dbdoc=<?php echo $where; ?>'>Vers la
                        destination</a>
 ...
 * */
    ...
    if (simpleQ($sql, $mysqli)) {
        ...
        <ul>
            ...
            <li class='button_appdoc'><a class='button_appdoc' href='?composant=browser&dbdoc=<?php echo $folder; ?>'>Dossier
                    parent</a>
            </li>
        </ul>
    ...
    ?>
    <ul>
        <li class='button_appdoc'><a class='button_appdoc' href="?composant=edit.db&dbdoc=<?php echo $dbdoc; ?>">Retour
                à l'éditeur</a></li>
        <li class='button_appdoc'><a class='button_appdoc'
                                     href="?composant=reader.db&dbdoc=<?php echo $dbdoc; ?>">Voir</a></li>
    </ul>
    <?php
} 
