...
if (($doc = mysqli_fetch_assoc($result)) != NULL) {
    ...
    <form action="page.xhtml.php" method="GET">
        ...
        <fieldset>
            <br/><input type="radio" name="option" value="aucunemethodechosie.doc">Choisir une des deux méthodes
            suivantes
            <br/><input type="radio" name="option" value="samefolder_move.doc" selected='selected' checked="checked">Méthode
            sûre ! Je crois.
