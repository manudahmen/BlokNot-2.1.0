        ...
        <ol id="listOfReaders">
            <li id='reader1'>
                <?php if ($viewer == 1) { ?>
                    <video id='video' preload="none">
                        <source src="<?php echo $urlApp . "/composant/display/download.php?id=" . $dbdoc; ?>"
                                type="<?php echo $mime ?>">
                    </video>
            ...
            <li id='reader3'>
                <?php if ($viewer == 3) {
                    ...
                    <script src="<?php echo $urlApp; ?>/js/ePub/build/epub.min.js" language="JavaScript"
                            type="text/javascript"></script>
                    <script src="<?php echo $urlApp; ?>/js/ePub/build/hooks.min.js" language="JavaScript"
                            type="text/javascript"></script>
                    <script src="<?php echo $urlApp; ?>/js/ePub/build/reader.min.js" language="JavaScript"
                            type="text/javascript"></script>
                    <script src="j<?php echo $urlApp; ?>/js/ePub/build/libs/zip.min.js" language="JavaScript"
                            type="text/javascript"></script>
                    <script>
            ...
            <li id='reader4'>
                <?php if ($viewer == 4) { ?>
                    <br/>
                    <iframe src="js/ViewerJS/#<?php echo $urlApp . "/composant/display/document.php?id=" . $dbdoc; ?>"
                            width='490' height='490' allowfullscreen webkitallowfullscreen></iframe>
                <?php } ?>
            </li>
            <li id='reader5'>
                <?php if ($viewer == 5) { ?>
                    ...
                    <br/>
                    <iframe src="js/ViewerJS/#<?php echo $urlApp . "/composant/display/download.php?id=" . $dbdoc; ?>"
                            width='490' height='490' allowfullscreen webkitallowfullscreen></iframe>
                <?php } ?>
            </li>
        </ol>
