...
?>
<a target="NEW" href="?composant=addAndLinkImage&mode=showform&form=address" accesskey="a"><img src="images/image.jpg"/>Introduire
    une image par adresse</a>

<a target="NEW" href="?composant=addAndLinkImage&mode=showform&form=remote" accesskey="a"><img src="images/image.jpg"/>Parcourir
    sur Bloc-notes</a>

<a target="NEW" href="?composant=addAndLinkImage&mode=showform&form=local" accesskey="a"><img src="images/image.jpg"/>Parcours
    local</a>

<a target="NEW" href="?composant=addAndLinkImage&mode=showform&form=webcam" accesskey="a"><img src="images/image.jpg"/>Prendre
    un cliché</a>
