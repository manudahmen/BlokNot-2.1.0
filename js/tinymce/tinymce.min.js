...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function i(e) {
            var t = e, n, r;
            if (!b(e))for (t = [], n = 0, r = e.length; r > n; n++)t[n] = e[n];
            return t
        }
        ...
        function n(e) {
            ...
            return i[e] ? i[e] : (l = t("id accesskey class dir lang style tabindex title"), c = t("address blockquote div dl fieldset form h1 h2 h3 h4 h5 h6 hr menu ol p pre table ul"), u = t("a abbr b bdo br button cite code del dfn em embed i iframe images input ins kbd label map noscript object q s samp script select small span strong sub sup textarea u var #text #comment"), "html4" != e && (l.push.apply(l, t("contenteditable contextmenu draggable dropzone hidden spellcheck translate")), c.push.apply(c, t("article aside details dialog figure header footer hgroup section nav")), u.push.apply(u, t("audio canvas command datalist mark meter output progress time wbr video ruby bdi keygen"))), "html5-strict" != e && (l.push("xml:lang"), h = t("acronym applet basefont big font strike tt"), u.push.apply(u, h), s(h, function (e) {
                ...
                r("a", "download"), r("link script images", "crossorigin"), r("iframe", "sandbox seamless allowfullscreen")), s(t("a form meter progress dfn"), function (e) {
        ...
        return function (r, l) {
            function c(t) {
                ...
                for (m = i("tr,td,th,tbody,thead,tfoot,table"), p = l.getNonEmptyElements(), g = l.getTextBlockElements(), n = 0; n < t.length; n++)if (r = t[n], r.parent && !r.fixed)if (g[r.name] && "li" == r.parent.name) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                function m(e) {
                    ...
                    for (t = e.prev; t && 3 === t.type;)if (r = t.value.replace(D, ""), r.length > 0)t.value = r, t = t.prev; else {
                        if (n = t.next) {
        ...
        return function (r, i) {
            function o(e) {
                ...
                return t === !1 || n.iOS ? !1 : ("string" != typeof t && (t = "table,images,div"), "false" === e.getAttribute("data-mce-resize") ? !1 : i.dom.is(e, t))
            }
            ...
            function u(e) {
                ...
                var n, o;
                if (!L && !i.removed)return C(x.select("images[data-mce-selected],hr[data-mce-selected]"), function (e) {
                    e.removeAttribute("data-mce-selected")
                }), o = "mousedown" == e.type ? e.target : r.getNode(), o = x.$(o).closest(z ? "table" : "table,images,hr")[0], t(o, U) && (v(), n = r.getStart(!0), t(n, o) && t(r.getEnd(!0), o) && (!z || o != n && "IMG" !== n.nodeName)) ? void l(o) : void c()
            }
    ...
    }), r(H, [p, A, D, C, M, u, d], function (e, n, r, i, o, a, s) {
        function l(e, t, i, a) {
            var s = this;
        ...
        var n = e.each;
        return {getCssText: t}
    }), r(O, [p, C, M, L, d, P], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e) {
            ...
            function f() {
                m({
                    ...
                    alignleft: [{
                        ...
                        defaultBlock: "div"
                    }, {selector: "images,table", collapsed: !1, styles: {"float": "left"}}],
                    aligncenter: [{
                        selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li",
                    ...
                    alignright: [{
                        ...
                        defaultBlock: "div"
                    }, {selector: "images,table", collapsed: !1, styles: {"float": "right"}}],
                    alignjustify: [{
                        selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li",
            ...
            function V(t, n, r, i) {
                ...
                function d(e, t) {
                    var n, r;
                    if (e)r = j.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), q.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === Q && (n.deleteData(0, 1), r.startContainer == n && r.startOffset > 0 && r.setStart(n, r.startOffset - 1),
                    r.endContainer == n && r.endOffset > 0 && r.setEnd(n, r.endOffset - 1)), q.remove(e, 1)), j.setRng(r); else if (e = c(j.getStart()), !e)for (; e = q.get(g);)d(e, !1)
                }
        ...
        return function (i) {
            function o(o) {
                ...
                function C() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (F = "LI"), H = F ? y(F) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, P) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()), H.appendChild(a.doc.createTextNode(" ")), H.appendChild(P)) : P.parentNode.insertBefore(H, P) : e() ? (a.insertAfter(H, t()), p(H)) : (P = t(), S = k.cloneRange(), S.setStartAfter(B), S.setEndAfter(P), L = S.extractContents(), "LI" == F && "LI" == L.firstChild.nodeName ? (H = L.firstChild, a.insertAfter(L, P)) : (a.insertAfter(L, P), a.insertAfter(H, P))), a.remove(B), g(H), c.add()
                }
                ...
                if (k = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(k), R = k.startContainer, A = k.startOffset, F = (l.force_p_newlines ? "p" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", D = a.doc.documentMode, M = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = E(R)) {
                        ...
                        if ((F && !M || !F && M) && (R = x(R, A)), B = a.getParent(R, a.isBlock), P = B ? a.getParent(B.parentNode, a.isBlock) : null, O = B ? B.nodeName.toUpperCase() : "", I = P ? P.nodeName.toUpperCase() : "", "LI" != I || o.ctrlKey || (B = P, O = I), /^(LI|DT|DD)$/.test(O)) {
                        ...
                        F && B === i.getBody() || (F = F || "P", b() ? (H = /^(H[1-6]|PRE|FIGURE)$/.test(O) && "HGROUP" != I ? y(F) : y(), l.end_container_on_empty_block && h(P) && a.isEmpty(B) ? H = a.split(P, B) : a.insertAfter(H, B), g(H)) : b(!0) ? (H = B.parentNode.insertBefore(y(), B), p(H), g(B)) : (S = k.cloneRange(), S.setEndAfter(B), L = S.extractContents(), _(L), H = L.firstChild, a.insertAfter(L, B), m(H), N(B), g(H)), a.setAttrib(H, "id", ""), i.fire("NewBlock", {newBlock: H}), c.add())
                    }
                }
            }
    ...
    }), r(W, [T, u, d, L, C, p], function (e, n, r, i, o, a) {
        ...
        var f = "onmousewheel"in document, h = !1, p = "mce-", m, g = 0, v = {
            ...
            init: function (e) {
                ...
                var i = this, o, c;
                i.settings = e = t.extend({}, i.Defaults, e), i._id = e.id || "tinymce-" + g++, i._aria = {role: e.role}, i._elmCache = {}, i.$ = a, i.state = new r({
                    visible: !0,
                    active: !1,
                    disabled: !1,
                    value: ""
        ...
        return function (s) {
            ...
            k(), m(), L(), re && (p(), v(), x(), R(), U(), _(), $(), o.iOS ? (O(), I(), V()) : g()), ne && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), H()), o.ie >= 11 && (I(), W(), _()), o.ie && (g(), z(), q()), te && (y(), b(), C(), S(), T(), A(), P(), F(), _())
        }
        ...
        return function (n) {
            ...
            function o(e) {
                return {id: e.id, blob: e.blob, base64: e.base64, filename: t.constant(r(e))}
            }
            ...
            function s(r) {
                return new e(function (e, i) {
                    ...
                    return n.url || l !== a ? (c = t.map(r, function (e) {
                        return {status: !1, blobInfo: e, url: ""}
                    }), void s()) : void e([])
                })
            }

            return n = t.extend({credentials: !1, handler: a}, n), {upload: s}
        }
    }), r(ye, [ge], function (e) {
        function t(t) {
        ...
        return function () {
            function t(e, t, n) {
                return {id: l(e), blob: l(t), base64: l(n), blobUri: l(URL.createObjectURL(t))}
            }
            ...
            var s = [], l = e.constant;
            return {create: t, add: n, get: r, getByUri: o, findFirst: i, destroy: a}
        }
            ...
            function l(n) {
                ...
                return c().then(r).then(o.upload).then(function (t) {
                    return t = e.map(t, function (e) {
                        var t;
                        return t = i.dom.select('images[src="' + e.blobInfo.blobUri() + '"]')[0], t && (s(t.src, e.url), i.$(t).attr({
                            src: e.url,
                            "data-mce-src": i.convertURL(e.url, "src")
                        })), {element: t, status: e.status}
                    }), n && n(t), t
                }, function () {
                })
            }
    ...
    }), r(we, [y, f, x, w, _, R, T, H, O, I, F, z, W, V, b, l, fe, E, k, he, u, d, pe, me, Ce], function (e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, x, C, w, _, E, N) {
        function k(e, t, i) {
            var o = this, a, s;
        ...
        var i = e.extend({
            init: function (e) {
                ...
                return e.menu && e.menu.visible() ? e.hideMenu() : (e.menu || (n = e.state.get("menu") || [], n.length ? n = {
                    ...
                    n.renderTo ? e.menu = n.parent(e).show().renderTo() : e.menu = t.create(n).parent(e).renderTo(), e.fire("createmenu"), e.menu.reflow(), e.menu.on("cancel", function (t) {
    ...
    }),a([l, c, u, d, f, h, p, m, g, y, b, x, C, _, E, N, k, S, T, R, A, B, D, M, H, L, O, I, F, z, W, V, U, $, q, j, K, Y, G, X, J, Q, Z, ee, te, ne, re, ie, oe, ae, se, le, ce, ue, de, fe, he, pe, me, ge, ye, we, _e, Ee, Ne, ke, Se, Te, Re, Ae, Be, De, Me, He, Le, Pe, Oe, Ie, Fe, ze, We, Ve, Ue, $e, qe, je, Ke, Ye, Ge, Xe, Je, Qe, Ze, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, ht, pt, mt, gt, vt, yt, bt, xt])
}(this);