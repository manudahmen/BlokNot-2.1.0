...
@section('content')
    ...
    <a href="?composant=browser&file=all&type=selection&mode=multiple&dbdoc=<?php echo $noteId; ?>" target="NEW">Ajouter un fichier</a>
    ...
    $noteId = rawurldecode(filter_input(INPUT_GET, 'dbdoc'));
